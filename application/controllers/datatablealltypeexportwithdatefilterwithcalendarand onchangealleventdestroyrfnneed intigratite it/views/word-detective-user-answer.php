			...
			<div class="col-md-12">
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						<div class="col-md-12">
							<h2 class="lel">Word Detective Users Answer Report</h2> </div>
					</div>
...
$("#package").change(function() {
    ...
    datastr={Package_id:packageid,  m_type: 9};
      $.ajax({
...
$("#asignment").change(function() {
    ...
    datastr={Assign_id:assignid,  m_type: 9};
      $.ajax({
...
$("#user_serch").on('click', function(){
    $.ajax({
           type: "POST",
           url: '<?php echo base_url()?>get-word-detective-user-ans-list',
