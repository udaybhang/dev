		...
		<div class="box-body">
          <div class="row">
            <div class="col-md-12">
	            ...
	            <form action="<?php echo base_url()?>save-difficulty-level" autocomplete="off" method="post">
	             <!-- /.form-group -->
	              <div class="col-md-6 form-group">
	              	<input type="type" class="form-control" placeholder="Difficultly Level" name="difficultly-level" required="required" />
	              </div>
	              <div class="col-md-6 form-group">
	              	<input type="type" class="form-control" placeholder="Points" name="points" required="required" />
	              </div>
				...
				<tr>
					...
					<td>
						<?php if(in_array("Edit", $permission)){ ?>
							<a href="<?php echo base_url().'diffi-edit/'.rtrim(strtr(base64_encode($topic_list['diffi_id']), '+/', '-_'), '='); ?>">Edit</a>
						<?php } ?>
					</td>
				</tr>
