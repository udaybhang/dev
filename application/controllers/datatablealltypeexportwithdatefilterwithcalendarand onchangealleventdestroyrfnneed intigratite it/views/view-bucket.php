						...
						<section class="content">
							...
							<div class="box box-col">
								...
								<div class="box-body">
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<div><h3>Question</h3><?php echo $bucket['bucket_question'] ?></div>
											</div>
										<!-- /.form-group -->
										</div>
										<div class="col-md-12" style="margin-bottom: 10px;">
											<div class="form-group">
												...
												<ul>
													<?php
														$options = explode('|', $bucket['bucket_option']);
										...
										<div class="col-md-12" style="margin-bottom: 10px;">
											<div class="form-group">
												...
												<ul>
										<?php
										$c_answer = explode('@|', $bucket['bucket_answer']);
										foreach($c_answer as $c_ans){
										?>
											<li><?php echo $c_ans ?></li>
										<?php
										}
										?>
												</ul>
									...
									<a href="<?php echo base_url()?>bucket-list" class="btn btn-primary btn-md" style="float: left; background-color:#112B4E; border-color: #112B4E; margin-top: 20px;">View All</a>
									<a href="<?php echo base_url().'bucket-edit/'.rtrim(strtr(base64_encode($mcq['mcq_id']), '+/', '-_'), '='); ?>" class="btn btn-primary btn-md" style="float: right; background-color:#112B4E; border-color: #112B4E; margin-top: 20px;">Edit</a>
								</div>
								<!-- /.box-body -->
							</div>
							<!-- /.box -->
