		...
		<div class="col-md-12">
			...
			<section class="invoice show">
				...
				<div class="row" style="background-color: #587EA3">
					<div class="col-md-12">
					<h2 class="lel">Multiple Choice Question</h2> </div>
				</div>
				...
				<div class="row">
					<div class="col-md-12">
						<section class="content">
							...
							<div class="box box-col">
								<div class="box-header with-border">
									<h3 class="box-title">Multiple Choice Question</h3>
								</div>
								<!-- /.box-header -->
								<div class="box-body">
									<form autocomplete="off" method="post" action="<?php echo base_url() ?>insert-mcq">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<textarea name="question" id="editor" placeholder="Question" class="form-control mcq_question"></textarea>
												</div>
											<!-- /.form-group -->
											</div>
											<div class="col-md-12" style="margin-bottom: 10px;">
												<div class="form-group">
													<input type="checkbox" name="canswer[]" class="canswer" value="" style="float: left; width: 5%; height: 30px;" />
													<input type="text" maxlength="70" required="required" name="opt[]" placeholder="Option 1" class="form-control" style="float: left; width: 95%;" />
												</div>
											</div>
											<div class="col-md-12" style="margin-bottom: 10px;">
												<div class="form-group">
													<input type="checkbox" name="canswer[]" class="canswer" value="" style="float: left; width: 5%; height: 30px;" />
													<input type="text" maxlength="70" required="required" name="opt[]" placeholder="Option 2" class="form-control" style="float: left; width: 95%;" />
												</div>
											</div>
											<div class="col-md-12" style="margin-bottom: 10px;">
												<div class="form-group">
													<input type="checkbox" name="canswer[]" class="canswer" value="" style="float: left; width: 5%; height: 30px;" />
													<input type="text" maxlength="70" name="opt[]" placeholder="Option 3" class="form-control" style="float: left; width: 95%;" />
												</div>
											</div>
											<div class="col-md-12" style="margin-bottom: 10px;">
												<div class="form-group">
													<input type="checkbox" name="canswer[]" class="canswer" value="" style="float: left; width: 5%; height: 30px;" />
													<input type="text" maxlength="70" name="opt[]" placeholder="Option 4" class="form-control" style="float: left; width: 95%;" />
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
											...
											<div class="col-md-12">
												<div class="form-group">
													<input type="text" name="timerange" id="timeformatExample1" placeholder="Time Limit (HH:MM:SS)" class="form-control">
												</div>
											</div>
										<!-- /.col -->
										</div>
						...
						?>
						<form method="post" action="<?php echo base_url()?>mcq-upload" enctype="multipart/form-data">

							<div class="col-md-12">
								<div class="form-group">
									<h3>Upload File</h3>
									<input type="file" name="userfile" accept=".csv" />
									<input type="submit" value="Submit" class="btn btn-primary btn-md " style="background-color:#112B4E; border-color: #112B4E; margin-top: 20px;" />
								</div>
							</div>
						</form>
						<?php }} ?>
