					...
					<div class="row">
						<div class="col-md-12">
							<div class="box box-col">
								<div class="box-header">
									...
									<form action="<?php echo base_url()?>neurons-per-day" method="post" id="formsub">
										<div class="col-md-3">
											<input type="text" class="form-control" name="date_to" placeholder="Date From" />
										</div>
										<div class="col-md-3" id="assmenu">
											<input type="text" class="form-control" name="date_from" placeholder="Date To" />
										</div>
										<div class="col-md-1">
							...
							<table class="table table-striped table-responsive" id="testtable2">
								...
								<tbody>
							<?php
								$a=1;foreach ($day_wise as $msqlists) {?>
							<tr>
								<td><?php echo $a ?>.</td>
								
								<td><?php echo $msqlists['mm_user_full_name']; ?></td>
                                                                <td><?php echo $msqlists['mm_user_email']; ?></td>
								<td><?php echo date('d F Y',strtotime($msqlists['created_date'])) ?></td>
