			...
			<div class="col-md-10">
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						<div class="col-md-12">
							<h2 class="lel">Ticket Trash</h2> </div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="box-header">
								<div class="col-md-6">
					              <h3 class="box-title">Ticket Trash</h3>
					            </div>
				...
				<td><?php echo $a; ?>.</td>
				 ...
				 <td><?php echo $list['ticket_sequence_no']; ?></td>
				 <td><?php echo $list['email_id']; ?></td>
				 <td><?php echo $list['subject']; ?></td>
				 <td><?php echo $list['status']; ?></td>
				 <td><?php echo $list['modified_date']; ?></td>
				 <td><a  href="#" class="recover" data-index="<?php echo $list['ticket_id']; ?>">Recover</a></td>
				 <td><a  href="#" class="delete" data-index="<?php echo $list['ticket_id']; ?>">Delete</a></td>
				</tr>
				<?php
				$a++;
				}
...
<script>
  ...
  $(document).ready(function(){
          $(document).on('click',".recover",function(){
              var res = confirm("Are you sure you want recover it");
              if(res==true){
                 var a = $(this).attr("data-index"); 
                  $.ajax({
                      type: 'GET',
                      url: "<?php echo base_url().'ticket-recover/'?>"+a,
                      success:function(data){
                         window.location.href="<?php echo base_url() ?>ticket-trash";
                      }
                  });
              }else{
                return false;
   ...
   $(document).ready(function(){
          $(document).on('click',".delete",function(){
              var res = confirm("Are you sure you want delete permanently");
              if(res==true){
                 var a = $(this).attr("data-index"); 
                  $.ajax({
                      type: 'GET',
                      url: "<?php echo base_url().'ticket-delete-permanantly/'?>"+a,
                      success:function(data){
                         window.location.href="<?php echo base_url() ?>ticket-trash";
                      }
                  });
