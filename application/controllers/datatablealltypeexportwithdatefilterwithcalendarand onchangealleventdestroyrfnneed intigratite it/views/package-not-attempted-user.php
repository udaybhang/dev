			...
			<div class="col-md-10 col-md-offset-1">
				...
				<section class="invoice show">
					...
					<div class="row" style="text-align: center">
						<h3 class="lel">Package Not Attempted Users Report</h3>
					</div>
					<div class="clearfix" style="margin-top: 20px;"></div>
					<div class="row">
						<div class="col-md-12">
							<!-- Search form (start) -->
							<form method='post' action="<?= base_url() ?>package-not-attempted-user/<?php echo $encode_pack_id; ?>" id="sssss">
							<div class="col-md-3">
...
$(".csv").click(function (event) {
  $(".loader").fadeIn("slow");
  $.post("<?php echo base_url()?>admindashboard/Report/export_users_data2",{package_id:"<?php echo $package_id?>"}, function (result){
    $(".ibox-content1").append(result);
     var today = new Date();
     var date = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
     var filename = "package-not-attempted-users"+date+".csv";  
