	...
	<div class="row main">
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						...
						<div class="col-md-12">
							...
							<h2 class="lel">Question Type</h2> </div>
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
	            ...
	            <form action="<?php echo base_url()?>type-create" autocomplete="off" method="post">
      ...
      <!-- /.box -->
				...
				<tr>
					...
					<td><?php echo $type_list['type_name'] ?></td>

					<td><?php echo $type_list['created_date'] ?></td>

					<!-- <td><a href="<?php echo base_url().'type-delete/'.rtrim(strtr(base64_encode($type_list['type_id']), '+/', '-_'), '='); ?>">Delete</a></td> -->
