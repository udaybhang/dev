	...
	<div class="row main">
			...
			<div class="col-md-12">
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						<div class="col-md-12">
							<h2 class="lel">Case Study Users Answer Report</h2> </div>
					</div>
      ...
      <div class="box box-col">
        <div class="box-header with-border">
        	...
        	<div class="col-md-2">
        		<form method="post"  id="case_study_ans_form" name="case_study_ans_form">
...
$("#package").change(function() {
    ...
    datastr={Package_id:packageid,  m_type: 4};
      $.ajax({
...
$("#asignment").change(function() {
    ...
    datastr={Assign_id:assignid,  m_type: 4};
      $.ajax({
...
$("#user_serch").on('click', function(){
    $.ajax({
           type: "POST",
           url: '<?php echo base_url()?>get-case-study-user-ans-list',
           data: $("#case_study_ans_form").serialize(), // serializes the form's elements.
