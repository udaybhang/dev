...
<div class="content-wrapper">
	...
	<div class="row main">
		<div class="col-md-12">
			...
			<div class="col-md-10">
				<?php
				if($this->session->flashdata('certi_message')){
					echo $this->session->flashdata('certi_message');
				}
				?>
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						<div class="col-md-12">
							<h2 class="lel">Cerfication List</h2> </div>
					</div>
					...
					<div class="row">
						...
						<input type="button" class="btn btn-primary btn-md" style="float: left;background-color:#112B4E; border-color: #112B4E; margin-left: 3px;" onclick="tableToExcel('testtable2', 'W3C Example Table');" value="Export to Excel" />
									 <?php } ?>
							<form action="<?php echo base_url()?>certification-lists" method="post" id="filtercheck">
				        	<div class="col-md-3">
						...
						<a href="<?php echo base_url()?>create-certification">
						<button type="button" class="btn btn-primary btn-md" style="float: right;background-color:#112B4E; border-color: #112B4E; margin-left: 3px; "> Create 	Cerfication </button></a>
						<?php } ?>
					</div>
				...
				<tr>
					<td><?php echo $a ?>.</td>
					<td><?php echo $msqlists['certification_name'] ?></td>
					<td><?php echo $msqlists['required_neurons'] ?></td>
					
					<td><?php echo ($msqlists['status'] ==1 ? "Active" : "Inactive" )?></td>
					<td>
						<?php if(in_array("View", $permission)){ ?>
						<a href="<?php echo base_url().'certification-view/'.rtrim(strtr(base64_encode($msqlists['mcq_id']), '+/', '-_'), '='); ?>">&nbsp;View&nbsp;</a>
						<?php }if(in_array("Edit", $permission)){ ?>
						<a href="<?php echo base_url().'certification-edit/'.rtrim(strtr(base64_encode($msqlists['mcq_id']), '+/', '-_'), '='); ?>">&nbsp;Edit&nbsp;</a>
						<?php }if(in_array("Delete", $permission)){ ?>
						<a href="<?php echo base_url().'certification-delete/'.rtrim(strtr(base64_encode($msqlists['mcq_id']), '+/', '-_'), '='); ?>">&nbsp;Delete&nbsp;</a>
						<?php } ?>
					</td> 
				</tr>
