									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<div><h3>Question</h3><?php echo $mcq['question'] ?></div>
											</div>
										<!-- /.form-group -->
										</div>
										...
										<div class="col-md-12" style="margin-bottom: 10px;">
											<div class="form-group">
												<h3>Time Limit</h3>
												<p><?php echo $mcq['mcq_time'] ?></p>
											</div>
										</div>
									<!-- /.col -->
									</div>
									<a href="<?php echo base_url()?>mcq-list" class="btn btn-primary btn-md" style="float: left; background-color:#112B4E; border-color: #112B4E; margin-top: 20px;">View All</a>
									<a href="<?php echo base_url().'mcq-edit/'.rtrim(strtr(base64_encode($mcq['mcq_id']), '+/', '-_'), '='); ?>" class="btn btn-primary btn-md" style="float: right; background-color:#112B4E; border-color: #112B4E; margin-top: 20px;">Edit</a>
								</div>
								<!-- /.box-body -->
							</div>
							<!-- /.box -->
