		...
		<div class="col-md-12">
			...
			<section class="invoice show">
				...
				<div class="row" style="background-color: #587EA3">
					<div class="col-md-12">
					<h2 class="lel">Word Detective</h2> </div>
				</div>
						...
						<section class="content">
							...
							<div class="box box-col">
								<div class="box-header with-border">
									<h3 class="box-title">Word Detective</h3>
								</div>
								<!-- /.box-header -->
								<div class="box-body">
									<form autocomplete="off" method="post" action="<?php echo base_url() ?>insert-word-detective">
										<div class="row">
											<div class="col-md-12">
											...
											<div class="col-md-12" >
												<div class="form-group">													
													<input type="text" maxlength="12" required="required" name="word" placeholder="Answer" class="form-control" />
												</div>
											</div>
											<div id="add_div">
												<div class="col-md-3" >
													<div class="form-group">													
														<select required  name="hint_type[]"  class="form-control" >
															...
															<option value="2">Hint Fill</option>															
														</select>														
													</div>
												</div>
												<div class="col-md-8" >
													<div class="form-group">													
														<input type="text" maxlength="150" required="required" name="hint[]" placeholder="Hint" class="form-control" />
