...
<?php
												...
												<div class="col-lg-6">
													<div class="col-md-12">
														...
														<div class="form-group">
															<select name="group_type" class="form-control" required="required" disabled="disabled">
		...
		if(in_array($masterpermission['permission_id'],$permission_id)){echo "checked=checked"; echo 'style="background-color: green"';}?> disabled/><label><?php echo $masterpermission['permission_description']; ?></label>
															</div>
															<?php $i++; } ?>
														</div>
														<div class="col-md-6">
		...
		if(in_array($p['portlet_id'],$pids)){echo "checked=checked"; echo 'style="background-color: green"';}?> disabled/><label><?php echo $p['portlet_name']; ?></label>
															</div>
															<?php $ip++; } ?>
														</div>
													</div>
