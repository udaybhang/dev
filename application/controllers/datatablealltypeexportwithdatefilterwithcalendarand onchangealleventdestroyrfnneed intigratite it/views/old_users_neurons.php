...
<div class="col-md-12">
            <div class="box box-info">
              ...
              <h3 class="box-title">Old Registered User's Neurons</h3>
              <div class="col-md-12">
          ...
          <div class="col-md-4"><input type="button" class="btn btn-primary btn-md" style="float: right;background-color:#112B4E; border-color: #112B4E;" onclick="tableToExcel('userdatas', 'Excel Report');" value="Export to Excel" /></div>
            ...
            <div class="col-md-12" style="margin-top:8px">
              <form action="<?php echo base_url() ?>show-old-users-neurons" method="post" id="Search_form">
                  <div class="col-md-4">
        ...
        <tr>
          ...
          <td><?php echo $all_date['new_assignment']; ?></td>
          <td><?php $attemp_old = $all_date['neurons']-$all_date['new_neuan']; if($attemp_old>0){ echo $attemp_old;}else{ echo 0;}?></td><!-- Attempted old user  -->
