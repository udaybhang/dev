			...
			<div class="col-md-10">
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						<div class="col-md-12">
							<h2 class="lel">Sequence Question List</h2> </div>
					</div>
					...
					<div class="row">
						...
						<?php }} ?>
							<form action="<?php echo base_url()?>sequence-list" method="post" id="filtercheck">
				        	<div class="col-md-3">
						...
						?>
						<a href="<?php echo base_url()?>create-sequence">
						<button type="button" class="btn btn-primary btn-md" style="float: right;background-color:#112B4E; border-color: #112B4E; margin-left: 3px; ">Create Sequence Question</button></a>
						<?php }} ?>
					</div>
				...
				<tr>
					<td><?php echo ++$a ?>.</td>
					<td><?php echo $sqences_list['question'] ?></td>
					<td><?php 
						$options = explode('sohrab', $sqences_list['options']);
						$b=0;
					...
					<td>
						...
						?>
						<a href="<?php echo base_url().'view-sequence/'.rtrim(strtr(base64_encode($sqences_list['sq_id']), '+/', '-_'), '='); ?>">&nbsp;View&nbsp;</a>
						<?php } if($p["permission_description"]=="Edit"){ ?>
						<a href="<?php echo base_url().'edit-sequence/'.rtrim(strtr(base64_encode($sqences_list['sq_id']), '+/', '-_'), '='); ?>">&nbsp;Edit&nbsp;</a>
						<?php } if($p["permission_description"]=="Delete"){ ?>
						<a href="<?php echo base_url().'delete-sequence/'.rtrim(strtr(base64_encode($sqences_list['sq_id']), '+/', '-_'), '='); ?>">&nbsp;Delete&nbsp;</a>
						<?php }} ?>
					</td>
				</tr>
