		...
		<div class="col-md-12">
			...
			<section class="invoice show">
				...
				<div class="row" style="background-color: #587EA3">
					<div class="col-md-12">
					<h2 class="lel">Create Match the following</h2> </div>
				</div>
						...
						<section class="content">
							...
							<div class="box box-col">
								<div class="box-header with-border">
									<h3 class="box-title">Create Match the following</h3>
								</div>
								<!-- /.box-header -->
								<div class="box-body">
									<form autocomplete="off" id="cms-form" method="post" action="<?php echo base_url() ?>match-follow">
										<div class="row">
											<div class="col-md-12">
													<div class="form-group">
														<textarea id="editor" name="question" placeholder="Question" id="noticeMessage" class="form-control mcq_question"></textarea>
													</div>
													<div class="form-group" style="margin-left:14px;margin-right:14px;">
														<input type="text" name="question_topic" class="form-control mcq_question" placeholder="Question Topic">
													</div>
													<div class="form-group" style="margin-left:14px;margin-right:14px;">
														<input type="text" name="answer_topic" class="form-control mcq_question" placeholder="Answer Topic">
													</div>
														<div class="col-md-12">
												<div class="form-group">
													...
													<div class="col-md-12">
														<div class="col-md-5">
															<div class="form-group" style="height:30px;">
																<input name="options1" placeholder="Question" class="form-control mcq_question" />
															</div>
														</div>
														<div class="col-md-5">
