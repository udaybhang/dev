	...
	<div class="row main">
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						...
						<div class="col-md-12">
							...
							<h2 class="lel">Question Topic</h2> </div>
      ...
      <div class="box box-col">
        <div class="box-header with-border">
          <h3 class="box-title">Question Topic</h3>
        </div>
            <?php 
			...
			<div class="box-body">
			   <div class="row">
				<div class="col-md-12">
				<form action="<?php echo base_url()?>topic-create" autocomplete="off" method="post">
	              <div class="form-group">
	              	<input type="type" class="form-control" placeholder="Topic Name" name="topic_name" required="required" />
	              </div>
      ...
      <!-- /.box -->
				...
				<tr>
					...
					<td><?php echo $topic_list['t_id'] ?></td>
					<td><?php echo $topic_list['t_name'] ?></td>

					<td><?php echo $topic_list['created_date'] ?></td>

					<!-- <td><a href="<?php echo base_url().'topic-delete/'.rtrim(strtr(base64_encode($topic_list['t_id']), '+/', '-_'), '='); ?>">Delete</a></td> -->
