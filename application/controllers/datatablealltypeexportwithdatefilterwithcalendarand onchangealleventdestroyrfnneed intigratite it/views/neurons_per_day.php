...
<div class="content-wrapper">
			...
			<div class="col-md-12">
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						<div class="col-md-12">
							<h2 class="lel">Neurons Per Day</h2> </div>
					</div>
  ...
  <div class="row" style="margin-top: 0%">
  		<form method="post" action="<?php echo base_url().'neurons-per-day'; ?>">
        <div class="col-md-12">
        	<div class="col-md-12">
	    		<div class="form-group">
	                <div class="icon-addon addon-lg">
					   <form action="<?php echo base_url()?>neurons-per-day" method="post" id="formsub">
					   		<div class="col-md-1" id="assmenu"><label>Date From:</label></div>
							<div class="col-md-3">
							
								<input type="text" class="form-control" name="date_to" placeholder="Date From" value="<?php if(!empty($search_date_from)){echo date("m/d/Y",strtotime($search_date_from));} ?>" />
							
							</div>
							<div class="col-md-1" id="assmenu"><label>Date To:</label></div>
							<div class="col-md-3" id="assmenu">
							
								<input type="text" class="form-control" name="date_from" placeholder="Date To" value="<?php if(!empty($search_date_to)){echo date("m/d/Y",strtotime($search_date_to));} ?>" />
        	...
        	<div class="col-md-12">
        		<form method="post" action="<?php echo base_url().'neurons-per-day'; ?>" class="hide">
			        <div class="col-md-3">
			    		<div class="form-group">
			                <div class="icon-addon addon-lg">
  ...
  <table class="table table-striped table-responsive" id="testtable2">
    <thead>
      <tr>
      	  <th>Sr.No</th><th>Name</th><th>Email</th><th>Date</th><th>Neurons</th>
	  </tr>
    </thead>
    <tbody>
<?php
