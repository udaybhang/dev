...
<input id="export" type="button" class="btn btn-info" value="Excel" onclick="tableToExcel('testtable2', 'Excel Report');"> 
<div class="dt-buttons"><div class="dt-buttons btn-group"><a class="btn btn-default buttons-pdf buttons-html5" tabindex="0" aria-controls="example" href="#"><span>Custom PDF</span></a></div><div id="example_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control input-sm" placeholder="" aria-controls="example"></label></div></div>
          ...
          <div class="row">
            <div class="col-md-7">
	            <form action="<?php echo base_url()?>extension-create" autocomplete="off" method="post" class="form-inline">
	             <!-- /.form-group -->
...
echo "<option value='" . $mtype['plan_id'] . "' >" . $mtype['plan_name']."</option>";
 ...
 ?>
      ...
      <!-- /.box -->
	          	...
	          	<div class="col-md-12" id="testtable2" style="padding-top: 10px;">
			...
			"buttons": [
				{
					...
					customize: function (doc) {
						...
						('https://datatables.net/media/images/logo.png');
