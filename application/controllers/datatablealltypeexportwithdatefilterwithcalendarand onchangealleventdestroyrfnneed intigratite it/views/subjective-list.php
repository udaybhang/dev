			...
			<div class="col-md-1"></div>
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						...
						<div class="col-md-12">
							...
							<h2 class="lel">Subjective Question List</h2> </div>
					...
					<div class="row">
						...
						?>
						<a href="<?php echo base_url()?>create-subjective">

						<button type="button" class="btn btn-primary btn-md" style="float: right;background-color:#112B4E; border-color: #112B4E; margin-left: 3px; ">Create Subjective</button></a>
						<?php }} ?>
				...
				<tr>
					...
					<td>
						...
						?>
						<a href="<?php echo base_url().'view-subjective/'.rtrim(strtr(base64_encode($question['subjective_id']), '+/', '-_'), '='); ?>">&nbsp;View&nbsp;</a>
						<?php }if($p["permission_description"]=="Edit"){?>
						<a href="<?php echo base_url().'subjective-edit/'.rtrim(strtr(base64_encode($question['subjective_id']), '+/', '-_'), '='); ?>">&nbsp;Edit&nbsp;</a>
						<?php }} ?>
					</td>
