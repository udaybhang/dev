			...
			<div class="col-md-1"></div>
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						<div class="col-md-12">
							<h2 class="lel">Interactive Case Map List</h2> </div>
					</div>
					...
					<div class="row">
						...
						<a href="<?php echo base_url()?>create-case-map">

						<button type="button" class="btn btn-primary btn-md" style="float: right;background-color:#112B4E; border-color: #112B4E; margin-left: 3px; ">Create Case Map</button></a><?php } ?></div>
							...
							<table class="table table-striped table-responsive" id="testtable2">
								...
								<tbody>
										...
										<?php
											...
											foreach ($case_map_data as $case_map) {	
										...
										<tr>
											...
											<td><?php echo ++$a ?>.</td>
											<td><?php echo $case_map['case_question']; ?></td>
											<td><?php echo $case_map['skills_map']; ?></td>
											<td><?php echo $case_map['skills_value']; ?></td>
											<td><?php 
                                                  $cs_map = $case_map['map_ques_id'];
                                                  echo $value = $this->Crud_modal->fetch_single_data('question','mm_interactive_case_study',"ques_id='$cs_map'");
											echo $value['question']; ?></td>
											<td><?php echo  date('d-m-Y H:i:s',strtotime($case_map['created_date'])) ?></td>
											<td><?php if(in_array("View", $permission)){?><!-- <a href="<?php echo base_url().'view-subjective/'.rtrim(strtr(base64_encode($question['subjective_id']), '+/', '-_'), '='); ?>">View</a> / --> <?php } ?> <?php if(in_array("Edit", $permission)){?><a href="<?php echo base_url().'edit-case-map/'.rtrim(strtr(base64_encode($case_map['case_interactive_id']), '+/', '-_'), '='); ?>">Edit</a> <?php } ?></td>
