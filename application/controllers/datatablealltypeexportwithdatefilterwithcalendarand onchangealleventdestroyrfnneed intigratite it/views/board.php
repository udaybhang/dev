			...
			<div class="col-md-10">
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						<div class="col-md-12">
							<h2 class="lel">Board list</h2> </div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="box-header">
					            <div class="col-md-12">
							<form action="<?php echo base_url()?>add-board" method="post" id="formids">
				        	<div class="col-md-3">
				        <input type="text" name="board" placeholder="Add-board" id="board" style="width: 500px;" class="form-control" required>
				        	</div>
        				
						
						<input type="submit" class="btn btn-primary btn-md" style="float: right;background-color:#112B4E; border-color: #112B4E; margin-left: 3px;" value="Add board"></div>
              </form>
             ...
             <?php } ?>
				...
				<tr>
					<td><?php echo $a ?>.</td>
					<td><?php echo $board1['board_name'] ?></td>
					<td>
						<?php if(in_array("Edit", $permission)){ ?>
						<a class="edit" value="<?php echo $board1['board_name'] ?>" id="<?php echo $board1['bid']?>">Edit</a>
						<?php } ?>
					</td>
				</tr>
  ...
  return function(table, name) {
    ...
    <script>
    	$('.edit').click(function(){
    		...
    		$("#board").val($(this).attr('value'));
    		$("#cleal").remove();
    		$("#formids").append('<input type="hidden" name="boardid" value="'+boardid+'" id="cleal"/>');
    		$("#formids").attr("action","<?php echo base_url()?>update-board");
