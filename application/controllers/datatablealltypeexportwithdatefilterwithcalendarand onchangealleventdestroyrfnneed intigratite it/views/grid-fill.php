			...
			<div class="col-md-10 col-md-offset-1">
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
			          <div class="col-md-12">
			          <h2 class="lel">Grid-FIB Create</h2> </div>
			        </div>
					...
					<div class="box-header with-border">
                  		<h3 class="box-title">Grid-FIB Create</h3>
                	</div>
					<!-- /.box-header -->
							 ...
							 <section class="content">
								...
								<div class="adjoined-bottom">
									...
									<div class="grid-container">
										...
										<form method="post" action="<?php echo base_url()?>create-grid-fill-in-blank">
													...
													<div class="main-div">
														<div class="col-md-12" style="margin-top: 20px;">
															<div class="form-group" style="">
																<textarea id="editor" name="fib_question" class="form-control" placeholder="Question"></textarea>
															</div>
														</div>
														<div class="col-md-12">
															<div class="col-md-4">
