              ...
              <section class="content">
                ...
                <div class="box box-col">
                  <div class="box-header with-border">
                    <h3 class="box-title">Interactive Case Study</h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                    <form autocomplete="off" method="post" action="<?php echo base_url() ?>edit-interactive-case-study-save" id="subjectform">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            <label>Question Context</label>
                            <textarea id="editor" name="question_context" placeholder="Question" class="form-control"><?php echo $interactive_case[0]['question_context']; ?></textarea>
                          </div>
                        </div>
                        <div class="col-md-12">											
                          <div class="form-group">
                          	<label>Question</label>
                          	<div class="form-control" contenteditable="true" id="ans" style="height: 200px;"><?php echo $interactive_case[0]['question']; ?></div>
                            <input type="hidden" name="ans" value="<?php echo $interactive_case[0]['question']; ?>"/>
                          </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group">
...
?>
                              <option value="<?php echo $tool_typ['id']?>" <?php if($interactive_case[0]['tool_type']==$tool_typ['id']){ echo "selected='selected'";} ?>>
...
?>
                              <option value="<?php echo $master_topic['t_id']?>" <?php if($interactive_case[0]['topic']==$master_topic['t_id']){ echo "selected='selected'";} ?>>
...
?>
                              <option value="<?php echo $master_type['type_id']?>" <?php if($interactive_case[0]['type']==$master_type['type_id']){ echo "selected='selected'";} ?>>
...
?>
                              <option value="<?php echo $master_skills_test['skills_id']?>" <?php if($interactive_case[0]['skill_tested']==$master_skills_test['skills_id']){ echo "selected='selected'";} ?>>
...
?>
                            ...
                            <input type="hidden" name="ques_id" value="<?php echo $interactive_case[0]['ques_id']; ?>">
                          </div>
                        </div>
