...
<div class="content-wrapper">
	...
	<div class="row main">
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						<div class="col-md-12">
							<h2 class="lel"><?php echo $date?> Report</h2> </div>
					</div>
      ...
      <!-- /.box -->
				...
				<?php
					$a=1;
					foreach ($useradata as $all_date) {
						if($this->Crud_modal->check_numrow('completed_assignment',"uid='$all_date[mm_uid]'")>0){
				?>
				<tr>
					<td><?php echo $a; ?>.</td>
					<td><?php echo $all_date['full_name']; ?></td>
					<td><?php echo $all_date['mm_user_email']; ?></td>
					<td><?php echo $all_date['contact_number']; ?></td>
				...
				<a href="<?php echo base_url()?>admin-home" type="button" class="btn btn-primary btn-md pull-left" style="float: right;
				background-color:#112B4E; border-color: #112B4E;">Back</a>
          	</div>
    </section>
    <!-- /.content -->
						</div>
