			...
			<div class="col-md-10">
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						<div class="col-md-12">
							<h2 class="lel">Widget Assignment</h2> </div>
					</div>
				...
				<td><?php echo $a; ?>.</td>
                 ...
                 <td class="get_c_name" data-id="<?php echo $list->c2_id ?>"><?php echo sizeof(explode(',',$list->c2_id)) ?></td>
				 <td><?php echo date('d-m-Y H:m:s',strtotime($list->create_date)) ?></td>
				 <td><!--<span data-toggle="modal" data-target="#myModal" class="widgetlink" data-id="<?php echo $list->w_id ?>">Restore</span>--></td>
				</tr>
				<?php
				$a++;
				}
...
<script type="text/javascript">
	$(".widgetlink").click(function(){
		var widgetsid = $(this).attr("data-id");
		$(".deletewidget").attr("id",widgetsid);
	});
	$(".deletewidget").click(function(){
		$.ajax({
		  method: "POST",
		  data: {'widgetid': $(this).attr("id")},
		  url: "<?php echo base_url() ?>restore-widget",
		  dataType: "JSON",
