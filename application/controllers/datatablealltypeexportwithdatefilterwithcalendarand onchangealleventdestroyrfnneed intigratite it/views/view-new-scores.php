...
<div class="content-wrapper">
			...
			<div class="col-md-12">
				...
				<section class="invoice show">
					...
					<div class="row" style="background-color: #587EA3">
						<div class="col-md-12">
							<h2 class="lel">Users Score</h2> </div>
					</div>
  ...
  <div class="row" style="margin-top: 0%">
  		<form method="post" action="<?php echo base_url().'view-new-scores'; ?>">
        <div class="col-md-4">
    		<div class="form-group">
                <div class="icon-addon addon-lg">
				    <input type="text" placeholder="Enter User's Email Id" class="form-control" id="title" name="title" value="<?php if(!empty($search_title)){ echo $search_title; } ?>" > 
			    </div>
            </div>
		</div>	
		<div class="col-md-1">
  ...
  <table class="table table-striped table-responsive" id="testtable2">
    <thead>
      <tr>
      	  <th>S.No</th><th>Email</th><th>Package Name</th><th>Assignment Name</th><th>Level Name</th>
		  <th>Time Taken</th><th>Total Time</th><th>Total Question</th><th>User Corrected</th>
		  <th>Objective Score</th><th>Subjective Score</th><th>Total Score</th><th>Total Level Marks</th>
