					...
					<div class="row">
						<div class="col-md-12">
							...
							<table class="table table-striped table-responsive" id="testtable2">
								...
								<tbody>
							<?php
								$a=1;foreach ($leaderboard_lists as $msqlists) {?>
							<tr>
								<td><?php echo $a ?>.</td>
								<td><?php echo $msqlists['mm_user_full_name']. ' ' .$msqlists['mm_last_name'] ?></td>
 <td><?php echo $msqlists['mm_user_email']; ?></td>
								<td><?php $id=$msqlists['mm_uid'];
$data_fetch=$this->Crud_modal->fetch_single_data('*',"user_data","uid='$id'");echo $data_fetch['contact_number']; ?></td>
                                                               
								<td><?php echo $msqlists['reg_date'] ?></td>
