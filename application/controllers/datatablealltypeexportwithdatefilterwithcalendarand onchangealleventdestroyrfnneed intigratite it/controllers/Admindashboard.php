	  	...
	  	try
			{
				if(($this->session->userdata('admin_name')!="" || $this->session->userdata('admin_name')!=null) && ($this->session->userdata('admin_role')!="" || $this->session->userdata('admin_role')!=null))
			    {
					...
					$createdata = array(
					        ...
					        'credits' =>$wallet_point,
					        'lumens' => $lumens,
					        'time_limit' => $time_limitt,
					        'type' => $ass_type
					);
     ...
     try
        {
               if(($this->session->userdata('admin_name')!="" || $this->session->userdata('admin_name')!=null) && ($this->session->userdata('admin_role')!="" || $this->session->userdata('admin_role')!=null))
         {
            ...
            if($atype['type']=='Manual'){
                ...
                echo '<div class="col-md-1" style="padding:3px; font-weight:800;">DLevel</div>';
                echo '<div class="col-md-2" style="padding:3px; font-weight:800;">Description</div>';
				echo '<div class="col-md-1" style="padding:3px; font-weight:800;">Competency</div>';
		
                echo '<div class="col-md-3" style="padding:3px; font-weight:800;">
						<div style="width:80%; float:left;"><span style="width:50%;float:left;">Start Date</span>
						<span style="width:50%;float:left;">Start Time</span></div>
					</div>
                </div>';
            }
            ...
            else
            	{
                  ...
                  echo '<div class="row">';
                  	echo 		'<div class="col-md-2" style="padding:3px; font-weight:800;">Level Name</div>
				<div class="col-md-1" style="padding:3px; font-weight:800;">Price</div>
				<div class="col-md-2" style="padding:3px; font-weight:800;">Lumens</div>
                 <div class="col-md-2" style="padding:3px; font-weight:800;">Instruction</div>
				<div class="col-md-1" style="padding:3px; font-weight:800;">Type</div>
				<div class="col-md-2" style="padding:3px; font-weight:800;">TimeLimit</div>
				<div class="col-md-1" style="padding:3px; font-weight:800;">Topic</div>
				<div class="col-md-1" style="padding:3px; font-weight:800;">Skills</div>';
                  	echo '</div>';
                  ...
                  echo '</div>';
                    // first column end
                  	 ...
                  	 echo '<div class="col-md-6">';
                  	 echo '<div class="row">';
                  	 	 echo '<div class="col-md-2" style="padding:3px; font-weight:800;">D Level</div>';
				echo '<div class="col-md-2" style="padding:3px; font-weight:800;">Limit</div>';
				echo '<div class="col-md-2" style="padding:3px; font-weight:800;">Description</div>';
				echo '<div class="col-md-2" style="padding:3px; font-weight:800;">Competency</div>';
				echo '<div class="col-md-4" style="padding:3px; font-weight:800;"><div style="width:80%; float:left;"><span style="width:50%;float:left;">Date</span><span style="width:50%;float:left;">Time</span></div></div>';
                  	echo '</div>';
            ...
            foreach ($rl as $value) {
             	if($atype['type']=='Manual'){
	                ...
	                echo '<div class="col-md-2" style="padding:3px;">
	                          <input type="text" class="form-control" value="'.$value['lvl_name'].'" maxlength="80"  id="name_'.$value['ml_id'].'" />
	                      </div>';
...
echo '<div class="col-md-1" style="padding:3px;"><input type="text" class="form-control" name="wallet_point" placeholder="Price" id="wallet_'.$value['ml_id'].'"  value="'.$value['credits'].'" maxlength="80" disabled="disabled" required="required" /></div>';
                          echo '<div class="col-md-2" style="padding:3px;"><input type="text" class="form-control" name="lumens" value="'.$value['lumens'].'"  id="lumens_'.$value['ml_id'].'" placeholder="Lumens" disabled="disabled" maxlength="80" required="required" /></div>';
                	echo '<div class="col-md-2" style="padding:3px;"><select id="inst_'.$value['ml_id'].'" disabled="disabled" class="form-control" ><option value="">Select Instruction</option></div>';
	                ...
	                echo '<div class="col-md-1" style="padding:3px;">
					 ...
					 echo '<div class="col-md-2" style="padding:3px;"><input class="form-control timeformatExample1" disabled="disabled" type="text" name="timerange" id="time_'.$value['ml_id'].'" placeholder="Time Limit (HH:MM:SS)" value="'.$value['time_limit'].'" required="required" /></div>';
					echo '<div class="col-md-1" style="padding:3px;">
              ...
              echo '</div>';
               ...
               echo '</div>';
				...
				for($i=1;$i<=$blank_input;$i++){
					if($atype['type']=='Manual'){
						echo '<div class="col-md-2" style="padding:3px;"><input type="text" class="form-control" name="levels[]" placeholder="Level Name" maxlength="80" required="required" /></div>';
						echo '<div class="col-md-1" style="padding:3px;">
                  ...
                  echo '<div class="row">';
                  	echo '<div class="col-md-6">';
                  		echo '<div class="row">';
                  		echo '<div class="col-md-2" style="padding:3px;"><input type="text" class="form-control" name="levels[]" placeholder="Level Name" maxlength="80" required="required" />
						</div>';
						echo '<div class="col-md-1" style="padding:3px;"><input type="text" class="form-control"  name="wallet_point" placeholder="Price" maxlength="80" required="required" /></div>';
                          echo '<div class="col-md-1" style="padding:3px;"><input type="text" class="form-control"  name="lumens" placeholder="Lumens" maxlength="80" required="required" /></div>';
						echo '<div class="col-md-2" style="padding:3px; ">
...
public function update_level(){
 	try
	{
		if(($this->session->userdata('admin_name')!="" || $this->session->userdata('admin_name')!=null) && ($this->session->userdata('admin_role')!="" || $this->session->userdata('admin_role')!=null))
	    {
	    	...
	    	$wallet_point=$this->input->post('walletpoint');
	    	$lumens=$this->input->post('lumens');
	    	...
	    	$keycompetency=$this->input->post('key');
	     	...
	     	$update_data['credits'] = $wallet_point;
	     	$update_data['lumens'] = $lumens;
...
public function list_mcq()
 	{
	  	try
		{
			   if(($this->session->userdata('admin_name')!="" || $this->session->userdata('admin_name')!=null) && ($this->session->userdata('admin_role')!="" || $this->session->userdata('admin_role')!=null))
	     {
			    $data['title']='Admin Dashboard for Monday Morning';
				$where = "mcq_status = '1'";
				$topic_list=$data['topic_list']= $this->Crud_modal->all_data_select('*','master_topic','status=1','t_name asc');
				...
				{
					$data['msqlist'] = $this->Crud_modal->fetchdata_with_limit('*','mcq',$where,'mcq_id desc','25');
				}
				$this->load->view('admintempletes/head',$data);
				$this->load->view('admintempletes/header',$data);	
			  	$this->load->view('admintempletes/sidebar',$data);
	  	...
	  	try
			{
		     ...
		     {
				 	$createdata = array(
			        'skills_name' => $this->input->post('skill_name'),
			        'order_id'	=> $this->input->post('order'),
					'skills_ab'	=> $this->input->post('ability'),
...
public function create_package_page(){
	try{
		if($this->session->userdata('admin_name')!="" || $this->session->userdata('admin_name')!=null){
	    	...
	    	asort($ridd);
	    	$ridays=implode(',', array_values($ridd));
...
public function insert_package(){
	try{
		if($this->session->userdata('admin_name')!="" || $this->session->userdata('admin_name')!=null){
			...
			//$insertdata['time_limit']=trim($this->input->post('time_limit'));
...
public function view_package_data(){
	try{
		if($this->session->userdata('admin_name')!="" || $this->session->userdata('admin_name')!=null){
	    	...
	    	$allass_lists= $this->Crud_modal->fetch_single_data('wallet_points,validity,ma_id,total_marks, lumens,time_limit ','mm_packages',$where1);
	    	$aslist['validity'] = $allass_lists['validity'];
	    	$aslist['total_marks'] = $allass_lists['total_marks'];
	    	$aslist['wallet_points']=$allass_lists['wallet_points'];
	    	$aslist['lumens']=$allass_lists['lumens'];
	    	$aslist['time_limit']=$allass_lists['time_limit'];
	...
	try{
		if($this->session->userdata('admin_name')!="" || $this->session->userdata('admin_name')!=null){
    		...
    		foreach ($packagesdata as $packagedata) {
				if($packagedata['ma_id']!=''){
					$allmaids[] = $packagedata['ma_id'];
				}
    		}
			$allmaid= rtrim(implode(',', $allmaids),",");
...
public function registered_verify(){  
	...
	public function block_user(){
		...
		if($this->input->post('data')=="Block"){			
			echo $this->Crud_modal->update_data("mm_uid='$id'","user",["user_status"=>0]);
		}else if($this->input->post('data')=="Unbolck"){
			echo $this->Crud_modal->update_data("mm_uid='$id'","user",["user_status"=>1]);
		}else{
			echo 0;
		}
	}
...
public function index_score()
   {  
	...
	public function neurons_lac(){
	 ...
	 public function master_skilltest_edit()
{
	try
	{
		if(($this->session->userdata('admin_name')!="" || $this->session->userdata('admin_name')!=null) && ($this->session->userdata('admin_role')!="" || $this->session->userdata('admin_role')!=null))
		{
			...
			$val = base64_decode(str_pad(strtr($v, '-_', '+/'), strlen($v) % 4, '=', STR_PAD_RIGHT));
			$where="skills_id='$val'";
			$data['lists']=$this->Crud_modal->fetch_single_data('*','master_skills_test',$where);
			$this->load->view('admintempletes/head',$data);
			$this->load->view('admintempletes/header',$data);	
			$this->load->view('admintempletes/sidebar',$data);
			$this->load->view('master-skill-edit',$data);
			$this->load->view('admintempletes/footer');
		}
	}
	catch(Exception $e)
...
public function update_skill_test()
{
	try
	{
		if(($this->session->userdata('admin_name')!="" || $this->session->userdata('admin_name')!=null) && ($this->session->userdata('admin_role')!="" || $this->session->userdata('admin_role')!=null))
		{
			...
			$field=array('skills_name'   		=> $this->input->post('skill_name'),
						 'order_id'	=> $this->input->post('order'),
						 'skills_ab'	=> $this->input->post('ability'),
						 'skills_desc'	=> $this->input->post('skill_description'),
						 'modified_date'			=> $date,
			...
			$data_return=$this->Crud_modal->update_data($where,'master_skills_test',$field);
			if($data_return=='1')
				  {
				  	$this->session->set_flashdata('item','<div class="success"><strong>Success!</strong> Skill has been updated successfully</div>');
				  	redirect(base_url().'skills-test-list');
				  }
				  else
				 {
 ...
 public function create_skill_test()
{
	try
	{
		if(($this->session->userdata('admin_name')!="" || $this->session->userdata('admin_name')!=null) && ($this->session->userdata('admin_role')!="" || $this->session->userdata('admin_role')!=null))
		{
			...
			$this->load->view('admintempletes/header',$data);	
			$this->load->view('admintempletes/sidebar',$data);
			$this->load->view('create-master-skill-test',$data);
			$this->load->view('admintempletes/footer');
		}
	}
	catch(Exception $e)
...
public function user_all_detail(){  
	//echo "hai"; die;
        ...
        $data['offset'] = ($this->uri->segment(3)) ? $this->uri->segment(3):'0';        
        $data['nav'] = $this->pagination->create_links();
		$data['datas'] = $this->pgn->all_reg_user_data_list1($data['limit'],$data['offset'],$title);
		if($this->input->post('email')!=""){
            $data['datas'] = $this->pgn->all_reg_user_data_list_by_email1($data['limit'],$data['offset'],$title);
        }
		$data['user_type']=$this->Crud_modal->fetch_alls('user_type','user_type_id desc');  
		$this->load->view('admintempletes/head',$data);
		$this->load->view('admintempletes/header',$data);    
		$this->load->view('admintempletes/sidebar',$data);
		$this->load->view('user-all-detail',$data);
		$this->load->view('admintempletes/footer');
...
$where1=date('Y-m-d', strtotime('-7 days'));
$where2=date('Y-m-d');
	
			
			$data['all_subscriber']=$this->Crud_modal->fetch_data_by_one_table_join_between('u.*, s.*',$table_name,$join1, $where1, $where2);

    	$this->load->view('admintempletes/head',$data);
		$this->load->view('admintempletes/header',$data);    
		$this->load->view('admintempletes/sidebar',$data);
		$this->load->view('subscription2', $data);
		$this->load->view('admintempletes/footer');
   ...
   public function  subscription_type_data()
   {
   	...
   	$tbl_name='mm_user_transaction_history';
  	$where="plan_id in($subs_id)";
   
   	 $user_id=$this->Crud_modal->fetch_all_data('user_id',$tbl_name,$where);
...
$where1=$this->input->post('to_date');
 ...
 //my
  //echo $where1=date($pickone, strtotime('+60 days'));
  $where1= date('Y-m-d', strtotime($pickone. ' + 60 days'));

$where2= date('Y-m-d', strtotime($picktwo. ' + 0 days'));
	if(strtotime($where2) > strtotime($where1))
	{
		echo '<script>
		
		    alert("DATE range should be less than 60 days");
		    </script>';
			}
	else{
		$table_name="mm_user_transaction_history as s";
			...
			$join1[2]="inner";
			 $where5="s.status=1";
			$all_subscriber=$this->Crud_modal->fetch_data_by_one_table_join_between1('u.*,s.*',$table_name,$join1,$pickone, $picktwo, $where5);
