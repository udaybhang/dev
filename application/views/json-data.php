   ...
   <div class="row">
    <div class="col-md-4">
     <select name="employee_list" id="employee_list" class="form-control">
      ...
      <option value="1">John Smoith</option>
      <option value="5">clara bery</option>
      <option value="6">barbara k hurly</option>
      <option value="7">Antonio j forbus</option>
     </select>
    </div>
    <div class="col-md-4">
...
$(document).ready(function(){
 $('#search').click(function(){
  ...
  {
   $.ajax({
    url:"<?php echo base_url().'get-employee-json'  ?>",
    method:"POST",
    data:{id:id},
    dataType:"JSON",
